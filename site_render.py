...
def report_card(title, btype, report_href, pdf_href=None, vision_href=None,
                badge=None, badge_class="squad"):
    """One report row: bold name (not a link), bowler type, badge, then View report / ▶ Vision / PDF."""
    ...
    return (f'<li><div class="rinfo"><b>{_html.escape(title)}</b>'
